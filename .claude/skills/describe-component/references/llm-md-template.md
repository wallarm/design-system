...
| Compound (`Dialog`, `Alert`) | Add required composition under "Locked"; one example in "Pairs with" |
| Commodity primitive (`Button`, `Badge`) | 3–4 lines total, or skip — the AI half-knows these |

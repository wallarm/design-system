...
const headingVariants = cva(
  'font-sans-display text-text-primary tracking-[-0.02em]',
  {
    variants: {
      size: {
        sm: 'text-sm',
...
export type HeadingProps<C extends ElementType = 'h1'> =
  PolymorphicComponentProps<C, HeadingVariantProps & HeadingBaseProps>;

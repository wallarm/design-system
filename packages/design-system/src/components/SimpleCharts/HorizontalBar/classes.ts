...
export const horizontalBarBarClasses = ['flex h-8 w-full overflow-hidden rounded-4'].join(' ');
...
export const horizontalBarLegendItemClasses = ['inline-flex items-center gap-4 px-4 py-2'].join(
  ' ',
);

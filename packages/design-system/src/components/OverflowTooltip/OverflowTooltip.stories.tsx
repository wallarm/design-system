        ...
        <OverflowTooltip>
          <OverflowTooltipTrigger>
            <div className="truncate">
              This is a very long text that will be truncated and automatically
...
export const NestedElements: StoryFn<OverflowTooltipProps> = () => {
  return (
    <div className="font-sans flex flex-col gap-16 w-300">
          ...
          <OverflowTooltipTrigger>
            <div className="border p-4">
              ...
              <p className="truncate">
                This is a nested element with truncate that will be
                automatically detected for overflow
              </p>
            </div>
          </OverflowTooltipTrigger>
          <OverflowTooltipContent>
            This is a nested element with truncate that will be automatically
            detected for overflow
          </OverflowTooltipContent>
        </OverflowTooltip>
      </div>
      ...
      <div>
        <p className="text-sm text-text-secondary mb-8">
          Multiple nested elements with truncate
        </p>
        <OverflowTooltip>
          <OverflowTooltipTrigger>
            <div className="border p-4">
              ...
              <p className="line-clamp-2">
                And this is a description that can span multiple lines but will
                be clamped to just two lines. The component will detect if
                either of these elements overflow.
              </p>
            </div>
          </OverflowTooltipTrigger>
          <OverflowTooltipContent>
            <div>
              <strong>Title:</strong> This is a very long title that might be
              truncated
              <br />
              <strong>Description:</strong> And this is a description that can
              span multiple lines but will be clamped to just two lines. The
              component will detect if either of these elements overflow.
            </div>
          </OverflowTooltipContent>
        </OverflowTooltip>
      </div>
...
export const ForceTooltip: StoryFn<OverflowTooltipProps> = () => {
  return (
    <div className="font-sans flex flex-col gap-16 w-300">
      <div>
        <p className="text-sm text-text-secondary mb-8">
          Force tooltip (even without overflow)
        </p>
      ...
      <div>
        <p className="text-sm text-text-secondary mb-8">
          Force tooltip with additional info
        </p>
        <OverflowTooltip forceTooltip>
          <OverflowTooltipTrigger>
          ...
          <OverflowTooltipContent>
            <div className="flex flex-col gap-2">
              ...
              <span className="text-sm">
                This tooltip provides extra context even when the trigger
...
export const DifferentSides: StoryFn<OverflowTooltipProps> = () => {
  const text =
    'This is a text that will be truncated and show tooltips on different sides';
...
export const DynamicContent: StoryFn<OverflowTooltipProps> = () => {
  ...
  return (
    <div className="font-sans flex flex-col gap-16 w-300">
      <div>
        <p className="text-sm text-text-secondary mb-8">
          Dynamic content with auto-detection
        </p>
        <OverflowTooltip>
          <OverflowTooltipTrigger>
            <div className="truncate">{text}</div>
      ...
      <button
        ...
        onClick={() => {
          ...
          setText(
            texts[Math.floor(Math.random() * texts.length)] ?? 'Short text',
          );
        }}
      >
        Change Text

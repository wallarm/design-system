...
// selection, resizing, pinning, DnD ordering, visibility, action bar,
// context menu
// ---------------------------------------------------------------------------

export const fullFeaturedColumns: TableColumnDef<SecurityHeaderEntry>[] = headerColumns.map(col => {

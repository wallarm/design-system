...
export const dayCellTriggerClass = cn(
  ...
  'data-[selected]:ring-2 data-[selected]:ring-inset data-[selected]:ring-border-strong-brand data-[selected]:font-medium',
  ...
  'data-[selected]:data-[today]:after:bg-border-strong-brand',

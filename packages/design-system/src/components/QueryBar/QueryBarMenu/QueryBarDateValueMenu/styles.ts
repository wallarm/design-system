...
export const cellTriggerClass =
  'w-full h-[36px] text-sm rounded-8 cursor-pointer hover:bg-states-brand-hover data-[selected]:bg-bg-fill-brand data-[selected]:text-white data-[selected]:font-medium';
...
export const dayCellTriggerClass = cn(
  ...
  'data-[selected]:bg-bg-fill-brand data-[selected]:text-white data-[selected]:font-medium',

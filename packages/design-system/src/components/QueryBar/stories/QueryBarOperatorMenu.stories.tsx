...
const meta = {
  title: 'Components/QueryBar/QueryBarOperatorMenu',
  component: QueryBarOperatorMenu,
  tags: ['autodocs'],
  argTypes: {
    fieldType: {
      control: 'select',
...
} satisfies Meta<typeof QueryBarOperatorMenu>;

export default meta;

const Template: StoryFn<typeof meta> = (args: QueryBarOperatorMenuProps) => {
 ...
 */
export const KeyboardNavigation: StoryFn<typeof meta> = (args: QueryBarOperatorMenuProps) => {
  const [selectedOperator, setSelectedOperator] = React.useState<FilterOperator | undefined>(
    undefined,
  );

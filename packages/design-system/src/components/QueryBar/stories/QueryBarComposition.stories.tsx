...
const meta = {
  title: 'Components/QueryBar/Composition',
  component: QueryBar,
  parameters: {
    layout: 'centered',
  },
...
const attackFields: FieldMetadata[] = [
  ...
  },
  {
    ...
    operators: ['=', '!=', '>', '<', '>=', '<=', 'in'],
    values: [
      { value: 1, label: '1 — Production API' },
      { value: 2, label: '2 — Staging API' },
      { value: 3, label: '3 — Admin Panel' },
      { value: 4, label: '4 — Mobile Backend' },
      { value: 5, label: '5 — Payment Service' },
    ],
  },
  {
    name: 'country',

...
import { useQueryBarExpression } from '../hooks/useQueryBarExpression';
...
describe('useQueryBarExpression', () => {
  ...
  describe('controlled mode (value prop)', () => {
    it('syncs conditions from a single Condition value', () => {
      ...
      const { result } = renderHook(() =>
        useQueryBarExpression({ fields, value: condition, error: false }),
      );
    ...
    it('syncs conditions from a Group value', () => {
      ...
      const { result } = renderHook(() =>
        useQueryBarExpression({ fields, value: group, error: false }),
      );
  ...
  describe('upsertCondition', () => {
    it('adds a new condition and calls onChange', () => {
      ...
      const { result } = renderHook(() =>
        useQueryBarExpression({ fields, onChange, error: false }),
      );
  ...
  describe('removeCondition', () => {
    it('removes a condition by chipId and calls onChange', () => {
      ...
      const { result } = renderHook(() =>
        useQueryBarExpression({ fields, value: group, onChange, error: false }),
      );

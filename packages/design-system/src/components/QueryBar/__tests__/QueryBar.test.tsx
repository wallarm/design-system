...
describe('QueryBar', () => {
  describe('basic rendering', () => {
    ...
    it('renders with custom placeholder', () => {
      render(<QueryBar fields={sampleFields} placeholder='Search attacks...' />);
      expect(screen.getByPlaceholderText('Search attacks...')).toBeInTheDocument();
    });

    it('applies custom className', () => {
      const { container } = render(<QueryBar fields={sampleFields} className='custom-class' />);
  ...
  describe('controlled mode with single condition', () => {
    it('displays chip when value is a single Condition', () => {
      ...
      render(<QueryBar fields={sampleFields} value={condition} />);
    ...
    it('calls onChange with null when chip is cleared', async () => {
      ...
      render(<QueryBar fields={sampleFields} value={condition} onChange={onChange} />);
  ...
  describe('controlled mode with Group (multi-condition)', () => {
    it('displays multiple chips with AND connector', () => {
      ...
      render(<QueryBar fields={sampleFields} value={group} />);
  ...
  describe('keyboard hint', () => {
    it('shows keyboard hint when showKeyboardHint is true', () => {
      render(<QueryBar fields={sampleFields} showKeyboardHint={true} />);
  ...
  describe('error state', () => {
    ...
    it('applies normal styling when error is false', () => {
      const { container } = render(<QueryBar fields={sampleFields} error={false} />);
      const field = container.querySelector('[data-slot="query-bar"]');

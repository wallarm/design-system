...
describe.skip('QueryBarOperatorMenu', () => {
  describe('operator filtering by field type', () => {
    it('displays operators for string field type', () => {
      render(<QueryBarOperatorMenu fieldType='string' onSelect={vi.fn()} open={true} />);
    ...
    it('displays operators for integer field type', () => {
      render(<QueryBarOperatorMenu fieldType='integer' onSelect={vi.fn()} open={true} />);
    ...
    it('displays operators for boolean field type', () => {
      render(<QueryBarOperatorMenu fieldType='boolean' onSelect={vi.fn()} open={true} />);
    ...
    it('displays operators for date field type', () => {
      render(<QueryBarOperatorMenu fieldType='date' onSelect={vi.fn()} open={true} />);
  ...
  describe('operator selection', () => {
    it('calls onSelect when operator is clicked', async () => {
      ...
      render(<QueryBarOperatorMenu fieldType='string' onSelect={onSelect} open={true} />);
  ...
  describe('open/closed state', () => {
    it('returns null when open is false', () => {
      const { container } = render(
        <QueryBarOperatorMenu fieldType='string' onSelect={vi.fn()} open={false} />,
      );
  ...
  describe('styling', () => {
    ...
    it('has correct base styling', () => {
      const { container } = render(
        <QueryBarOperatorMenu fieldType='string' onSelect={vi.fn()} open={true} />,
      );

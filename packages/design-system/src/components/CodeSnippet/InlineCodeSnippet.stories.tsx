...
export const Default: StoryFn<typeof meta> = () => (
    <VStack align='start'>
        <p className='text-xs text-text-primary'>
            Small text: Run <InlineCodeSnippet code='npm install @wads/ui' /> to install
            dependencies.
        </p>
        <p className='text-sm text-text-primary'>
            Medium text: Run <InlineCodeSnippet code='npm install @wads/ui' /> to install
            dependencies.
        </p>
        <p className='text-base text-text-primary'>
            Large text: Run <InlineCodeSnippet code='npm install @wads/ui' /> to install
            dependencies.
        </p>
    </VStack>
);
    ...
    <VStack align='start' spacing={16}>
        <VStack align='start' spacing={4}>
            ...
            <div className='text-xs text-text-primary'>
                ...
                <InlineCodeSnippet code='npm install @wads/ui' size='sm' /> and then apply the
                following...
            </div>
        </VStack>
        <VStack align='start' spacing={4}>
            ...
            <div className='text-sm text-text-primary'>
                To start creating an interface, run{' '}
                <InlineCodeSnippet code='npm install @wads/ui' size='md' /> and then apply the
                following...
            </div>
        </VStack>
        <VStack align='start' spacing={4}>
            ...
            <div className='text-base text-text-primary'>
                To start creating an interface, run{' '}
                <InlineCodeSnippet code='npm install @wads/ui' size='lg' /> and then apply the
                following...
            </div>
        </VStack>
    </VStack>
...
export const NonCopyable: StoryFn<typeof meta> = () => (
    <p className='text-sm text-text-primary'>
        ...
        <InlineCodeSnippet code='npm install @wads/ui' copyable={false} />
    </p>
);

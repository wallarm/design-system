...
describe('FilterOperatorMenu', () => {
  describe('operator filtering by field type', () => {
    it('displays operators for string field type', () => {
      render(<FilterOperatorMenu fieldType='string' onSelect={vi.fn()} open={true} />);
    ...
    it('displays operators for integer field type', () => {
      render(<FilterOperatorMenu fieldType='integer' onSelect={vi.fn()} open={true} />);
    ...
    it('displays operators for boolean field type', () => {
      render(<FilterOperatorMenu fieldType='boolean' onSelect={vi.fn()} open={true} />);
    ...
    it('displays operators for date field type', () => {
      render(<FilterOperatorMenu fieldType='date' onSelect={vi.fn()} open={true} />);
  ...
  describe('operator selection', () => {
    it('calls onSelect when operator is clicked', async () => {
      ...
      render(<FilterOperatorMenu fieldType='string' onSelect={onSelect} open={true} />);
  ...
  describe('open/closed state', () => {
    it('returns null when open is false', () => {
      const { container } = render(
        <FilterOperatorMenu fieldType='string' onSelect={vi.fn()} open={false} />,
      );
  ...
  describe('styling', () => {
    ...
    it('has correct base styling', () => {
      const { container } = render(
        <FilterOperatorMenu fieldType='string' onSelect={vi.fn()} open={true} />,
      );

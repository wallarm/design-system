...
describe('FilterMainMenu', () => {
  describe('field list display', () => {
    it('displays all fields by label', () => {
      render(<FilterMainMenu fields={mockFields} onSelect={vi.fn()} open={true} />);
    ...
    it('returns null when open is false', () => {
      const { container } = render(
        <FilterMainMenu fields={mockFields} onSelect={vi.fn()} open={false} />,
      );
  ...
  describe('search functionality', () => {
    ...
    it('resets search query after field selection', async () => {
      ...
      render(<FilterMainMenu fields={mockFields} onSelect={onSelect} open={true} />);
  ...
  describe('styling', () => {
    it('applies custom className', () => {
      ...
      const menu = container.querySelector('[data-slot="filter-main-menu"]');
      expect(menu).toHaveClass('custom-class');
    });

    it('has correct base styling', () => {
      const { container } = render(
        <FilterMainMenu fields={mockFields} onSelect={vi.fn()} open={true} />,
      );

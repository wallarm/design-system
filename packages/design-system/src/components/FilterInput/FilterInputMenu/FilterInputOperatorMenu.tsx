...
export interface FilterInputOperatorMenuProps {
  /**
...
/**
 * FilterInputOperatorMenu component
 * Dropdown menu for selecting filter operators based on field type
 */
export const FilterInputOperatorMenu: FC<FilterInputOperatorMenuProps> = ({
  fieldType,
  operators,
  onSelect,
  open = false,

...
export const NavPanelGroupLabel: FC<NavPanelGroupLabelProps> = ({
  ...
  return (
    <button
      ...
      className={cn(
        'overlay flex h-32 shrink-0 w-full cursor-pointer items-center gap-8 rounded-6 py-8 pr-8 text-sm text-text-primary opacity-85 transition-colors outline-none hover:opacity-100 hover:overlay-states-primary-hover focus-visible:opacity-100 focus-visible:overlay-states-primary-hover active:overlay-states-primary-pressed',
        className,
      )}
    >
      {Icon && (

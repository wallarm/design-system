 ...
 * Automatically adapts to single/range calendar mode from context.
 */
  ...
  return (
    <DatePicker.Context>
      {api => {
        ...
        // Get the target month for this grid (used for hiding dates in range mode)
                ...
                {weeks.map((week, weekIndex) => (
                  <DatePicker.TableRow key={weekIndex}>
                    {week.map(day => {
                      ...
                      // For outside dates (in single mode or visible outside dates in range mode),
